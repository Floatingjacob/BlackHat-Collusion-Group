...
Public Class Form1
    ...
    Private holdTime As Integer = 1000 ' Hold in milliseconds
    Private initialWaitTime As Integer = 1000 ' Wait before fading in in milliseconds
    ...
    Private Sub Form1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        ' Create and start the wait timer
    ...
    Private Sub Timer1_Tick(sender As Object, e As EventArgs)
        If fadeIn Then
            ...
            If fadeValue >= 1 Then
                fadeIn = False
                Timer1.Interval = holdTime ' Hold the image fully visible
            End If
        Else
            Timer1.Interval = 10
            fadeValue -= 0.01F
